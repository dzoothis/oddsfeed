  ...
  <div class="bet-types-container">
    <div class="filters">
      ...
      <div v-if="leagues.length > 0" class="league-selector">
        <input type="text" v-model="leagueSearch" placeholder="Search leagues..." class="league-search">
    ...
    <div class="matches-grid" v-if="matches.length > 0">
      <div v-for="match in matches" :key="match.id" class="match-card" @click="selectMatch(match)">
    ...
    <div v-if="selectedMatch" class="bet-types-modal">
      <div class="modal-content">
        ...
        <div class="market-tabs">
          <button v-for="marketType in availableMarketTypes" :key="marketType"
            :class="{ active: activeMarketType === marketType }" @click="activeMarketType = marketType">
            {{ formatMarketType(marketType) }}
          </button>
        </div>

        <div class="markets-list">
          <div v-for="market in activeMarkets" :key="market.type" class="market-item">
            <h4>{{ market.name }}</h4>
            <div class="outcomes">
              <div v-for="outcome in market.outcomes" :key="outcome.name" class="outcome">
